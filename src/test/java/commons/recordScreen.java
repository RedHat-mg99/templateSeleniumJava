...
public class recordScreen extends ScreenRecorder{
    ...
    public recordScreen(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat, Format screenFormat,
    ...
    public static void startRecord(String methodName) throws IOException, AWTException {
        File file = new File("./Output/test-recordings/");
        ...
        screenRecorder = new recordScreen(graphicsConfiguration, captureSize,
